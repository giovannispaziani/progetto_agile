            ...
            <div class="card ">
                ...
                <div class="card-body ">
                    ...
                    <div class="form-group">
                        <label for="titoloPubblicazioneScientifica">Titolo</label>
                        <input type="text" class="form-control" id="titoloPubblicazioneScientifica" placeholder="Inserisci titolo pubblicazione">
                      </div>
                      <div class="form-group">
                        <label for="linkPubblicazioneScientifica">Fonte</label>
                        <input type="text" class="form-control" id="fontePubblicazioneScientifica" placeholder="Inserisci titolo pubblicazione">
                      </div>
