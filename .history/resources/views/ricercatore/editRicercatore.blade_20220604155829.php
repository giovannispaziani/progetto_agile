            ...
            <div class="card ">
              ...
              <div class="card-body ">
                ...
                <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                    <label class="col-sm-2 col-form-label">{{ __('Immagine profilo') }}</label>
                    ...
                    <div>
                        ...
                        <a href="#pablo" class="btn btn-danger btn-round fileinput-exists" data-dismiss="fileinput"><i class="fa fa-times"></i> Rimuovi</a>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-7">
                      <div class="form-group{{ $errors->has('surname') ? ' has-danger' : '' }}">
                        <input class="form-control{{ $errors->has('surname') ? ' is-invalid' : '' }}" name="name" id="input-name" type="text" placeholder="{{ __('Name') }}" value="{{ old('name', auth()->user()->name) }}" required="true" aria-required="true"/>
                        @if ($errors->has('surname'))
                          <span id="name-error" class="error text-danger" for="input-surname">{{ $errors->first('name') }}</span>
                        @endif
                      </div>
                    </div>
                  </div>
