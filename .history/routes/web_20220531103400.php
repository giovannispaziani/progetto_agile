...
Route::group(['middleware' => 'auth'], function () {
	...
	Route::get('profile', ['as' => 'profile.edit', 'uses' => 'App\Http\Controllers\ProfileResearcherController@edit']);
    Route::get('profileRicercatore', ['as' => 'ricercatore.editRicercatore', 'uses' => 'App\Http\Controllers\ProfileController@edit']);
