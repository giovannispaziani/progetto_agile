...
Route::group(['middleware' => 'auth'], function () {
	...
	Route::get('/pubblicazioniRicercatore', 'App\Http\Controllers\AddPublicationController@index')->name('pubblicazioniRicercatore');
    //Route::post('/pubblicazioniRicercatore','App\Http\Controllers\AddPublicationController@aggiungiPubblicazione')->name('pubblicazioneRicercatore-post');
