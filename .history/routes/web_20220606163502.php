...
Route::group(['middleware' => 'auth'], function () {
	...
	Route::get('pubblicazioneRicercatore', 'App\Http\Controllers\AddPublicationController@index')->name('pubblicazioneRicercatore');
    Route::post('pubblicazioneRicercatore','App\Http\Controllers\AddPublicationController@AddPubblicazione')->name('pubblicazioneRicercatore');
